...
sp_infer.add_argument('--list', help='Path to the list of protein complexes that we need to score.\
                                     The list should contain the PPIs in the following format: antigen_ch1,antibody_ch2,\
                                     where PID is the name of PDB files, ch1 is the first chain(s) of the antigen\
                                     , and ch2 is the chains of the antibody. Ensure that PID does not contain an underscore')
sp_infer.add_argument('--ppi', help='PPI in format antigen_ch1,antibody_ch2 (mutually exclusive with the --list option)')
