...
from equivariant_attention.modules import get_basis_and_r, GSE3Res, GNormSE3, GConvSE3
...
num_degrees = 1
num_features = 7 #node data dim
edge_dim = 14  #edge data dim
...
train1 = []
train2 = []
data1 = torch.load('./dataset/fea/1a2y_B.pt',
                  map_location=device)
train1.append(data1)
data2 = torch.load('./dataset/fea/1a2y_C.pt',
                  map_location=device)
train2.append(data2)
