...
class ViT_Hybrid(nn.Module):
    ...
    def __init__(self, config, img_size=24, num_classes=2, zero_head=False, vis=False, channels=13):
...
class ViT_Hybrid_encoder(nn.Module):
    def __init__(self, config, img_size=24, zero_head=False, vis=False, channels=13):
