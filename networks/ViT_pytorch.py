...
class Transformer(nn.Module):
    def __init__(self, config, img_size, channels, vis):
        super(Transformer, self).__init__()
        self.embeddings = Embeddings(config, img_size=img_size, in_channels=channels)
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=24, num_classes=2, zero_head=False, vis=True, channels=13):
