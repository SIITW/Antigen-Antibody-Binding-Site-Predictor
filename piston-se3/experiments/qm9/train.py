...
from se3.experiments.qm9 import models #as models
...
def Ttest_epoch(epoch, model, loss_fnc, dataloader, FLAGS):
    model.eval()
...
def main(FLAGS, UNPARSED_ARGV):
    ...
    for epoch in range(FLAGS.num_epochs):
        ...
        Ttest_epoch(epoch, model, task_loss, test_loader, FLAGS)
...
if __name__ == '__main__':
    ...
    FLAGS.device = torch.device('cuda:1') if torch.cuda.is_available() else torch.device('cpu')
